            ...
            <tbody class="table-group-divider">
                @foreach ($alunos as $aluno)
                    <tr>
                        <td>
                            @if ($aluno->image)
                                <img style="max-height: 100px;" src="/img/events/{{ $aluno->image }}">
                            @else
                        ...
                        <td>{{ $aluno->id }}</td>
                        <td>{{ $aluno->nome }}</td>
                        <td><a class="btn btn-info" href="{{ route('show', $aluno->id) }}"><i class="bi bi-eye-fill"></i></a></td>
                        <td><a class="btn btn-primary" href="{{ route('edit', $aluno->id) }}"><i class="bi bi-pencil-square"></i></a></td>
                        <td>

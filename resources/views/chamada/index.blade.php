...
@section('content')
    ...
    <nav class="navbar" style="background-color: #000000;">
        <div class="container-fluid">
            <a class="btn btn-lg btn-custom btn-white" href="{{ route('index') }}"><b><i class="bi bi-arrow-left"></i>
                    Voltar</b></a>
            <div>
                <a class="btn btn-lg btn-custom btn-orange" href="{{ route('index_turma') }}"><i class="bi bi-people"></i>
                    Turmas</a>
            </div>
            <div>
